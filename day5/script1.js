...
function onEdit(td)
{if(confirm("Are you update your details")){
...
if(validateName(a)&&validateDept(b) || validateName(a)&&validateSub(c)){return true;}
else{return false;}
...
function validateDept(b){
const Deptpattern=/^[a-zA-Z\s'-]+$/;
return Deptpattern.test(b);
}
function validatesub(c){
const Subpattern=/^[a-zA-Z0-9'-]+$/;
return Subpattern.test(c);
}
